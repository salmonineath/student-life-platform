...
export default function GroupList({
  ...
  return (
    <div className="flex flex-col h-full w-full overflow-hidden">
      ...
      <div className={`shrink-0 border-b border-slate-200 flex items-center gap-2 transition-all duration-300 ${collapsed ? "px-2 py-3 justify-center" : "px-4 py-4"}`}>
        {!collapsed && (
        ...
        <button
          ...
          className="p-1.5 rounded-lg hover:bg-slate-100 text-slate-600 hover:text-indigo-600 transition-colors shrink-0"
      ...
      >
        <div className="px-4 py-2 relative">
          ...
          <input
            ...
            className="w-full pl-9 pr-3 py-2 bg-slate-100 rounded-xl text-sm text-slate-800 placeholder:text-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500"
          />
        </div>
      </div>
