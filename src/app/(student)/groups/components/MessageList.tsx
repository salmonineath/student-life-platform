...
export default function MessageList({ messages, currentUserId }: Props) {
  ...
  if (messages.length === 0) {
    return (
      <div className="h-full flex flex-col items-center justify-center py-20 text-center bg-slate-100">
        ...
        <p className="text-xs text-slate-500 mt-1">Say hello to your group! 👋</p>
      </div>
    );
  }
  ...
  return (
    <div className="min-h-full px-4 py-4 space-y-4 bg-slate-100">
