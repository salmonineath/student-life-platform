...
export default function ProfilePage() {
  ...
  return (
      <>
        ...
        {/* ── Page title ── */}
        <div className="mb-6">
          <p className="text-sm font-semibold tracking-widest uppercase text-stone-600 mb-1">
            Account
          </p>
        ...
        <div className="flex gap-6 items-start">
          ...
          <div className="w-64 shrink-0 flex flex-col gap-4">
            ...
            <div className="bg-white border border-stone-200 rounded-2xl p-6 flex flex-col items-center text-center hover:shadow-md transition-shadow">
              {loading ? (
                ...
                <>
                  ...
                  <p className="text-xs text-stone-600 mb-3">{profile?.major}</p>
            ...
            <div className="bg-white border border-stone-200 rounded-2xl p-4 flex flex-col gap-3">
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-stone-600">Role</p>
                  {loading
              ...
              <div className="flex items-center gap-3">
                ...
                <div>
                  <p className="text-[10px] text-stone-600">Academic Year</p>
                  {loading
          ...
          <div className="flex-1 flex flex-col gap-4">
                ...
                {fields.map((field) => (
                  <div key={field.label} className="flex items-center gap-4 py-4 first:pt-0 last:pb-0">
                    ...
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] font-medium text-stone-600 mb-0.5">{field.label}</p>
                      {loading
            ...
            <div className="bg-white border border-dashed border-stone-200 rounded-2xl p-6 flex flex-col items-center justify-center text-center gap-2 min-h-[120px]">
              <p className="text-sm font-semibold text-stone-600">More sections coming soon</p>
              <p className="text-xs text-stone-500">Security, preferences, notifications…</p>
            </div>
